...
return [
    ...
    'columns' => [
        ...
        'default_flag' => $GLOBALS['TCA']['sys_language']['columns']['flag'],
        'available_languages' => [
    ...
    'palettes' => [
        'language' => [
            ...
            'showitem' => 'default_languagelabel,default_language,--linebreak--,default_locale,--linebreak--,default_flag'
        ]
    ]
];